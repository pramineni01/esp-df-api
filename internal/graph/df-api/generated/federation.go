...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) ([]fedruntime.Entity, error) {
	...
	for _, rep := range representations {
		...
		case "DFDataFilter":
			...
			entity, err := ec.resolvers.Entity().FindDFDataFilterByID(ctx,
				id0)
			if err != nil {
				return nil, err
			}
		...
		case "DFForecast":
			...
			entity, err := ec.resolvers.Entity().FindDFForecastByID(ctx,
				id0)
			if err != nil {
				return nil, err
			}
		...
		case "DFScenario":
			...
			entity, err := ec.resolvers.Entity().FindDFScenarioByID(ctx,
				id0)
			if err != nil {
				return nil, err
			}
